...
namespace ShellShock
{
    public class Movement : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            movementDirection = new Vector2(Input.GetAxis("Player_" + GetComponent<ShellShock.Player>().PlayerNumber + "_LJoystickX"), Input.GetAxis("Player_" + GetComponent<ShellShock.Player>().PlayerNumber + "_LJoystickY")).normalized;
