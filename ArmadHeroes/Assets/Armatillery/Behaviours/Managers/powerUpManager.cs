...
namespace Armatillery
{
    public class powerUpManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            //set up singleton
            m_instance = this;
            dropBounds = dropBoundsObject.GetComponentsInChildren<Collider2D>();
        }
        ...
        void begin()
        {
            ...
            */
            ...
            //New method!
            Bounds b = dropBounds[Random.Range(0, dropBounds.Length - 1)].bounds;
