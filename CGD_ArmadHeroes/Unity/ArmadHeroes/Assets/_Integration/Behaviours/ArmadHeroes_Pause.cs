...
namespace ArmadHeroes
{
    public class ArmadHeroes_Pause : MonoBehaviour
    {
        ...
        void ChangeState(PauseState _state)
        {
            switch (_state)
            {
                case PauseState.paused:
                    ...
                    if (SoundManager.instance) { SoundManager.instance.StopAllAudio(); }
        ...
        private void MainMenuTick()
        {
            ...
            if (ControllerManager.instance.GetController(playerID).confirm.JustReleased())
            {
                ...
                switch (MainMenuOption)
                {
                    ...
                    case MainMenu.Exit:
                        ...
                        for (int i = 0; i < 8; i++)
                        {
                            GlobalPlayerManager.instance.playerData[i].activePlayer = false;
                        }
