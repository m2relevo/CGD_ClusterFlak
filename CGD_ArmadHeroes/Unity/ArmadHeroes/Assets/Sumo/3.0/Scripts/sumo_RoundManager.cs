       ...
       delegate void displayMessage();      
        ...
        void Update()
		{
			...
			if (Rankings.Count == Players.Count - 1 || Input.GetKeyDown (KeyCode.R)) {
				...
				{	
					ArmadHeroes.SumoManager.instance.countDown = false;
					ArmadHeroes.SumoManager.instance.resetMineRings ();
					RoundOver ();
				}
		...
		void enablePlayers()
		{
			for (int i = 0; i < Players.Count; i++)
			{
				...
				{
				case 0:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 45f) * new Vector2(1f,1f);
					break;
				case 1:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 225f) * new Vector2(1f,1f);
					break;
				case 2:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 135f) * new Vector2 (1f, 1f);
					break;
				case 3:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 305f) * new Vector2 (1f, 1f);
					break;
				case 4:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 90f) * new Vector2 (1f, 1f);
					break;
				case 5:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 270f) * new Vector2 (1f, 1f);
					break;
				case 6:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 180f) * new Vector2 (1f, 1f);
					break;
				case 7:
					Players [i].GetComponent<sumo_VehicleMovementV2> ().direction = Quaternion.Euler (0, 0, 0f) * new Vector2 (1f, 1f);
					break;
				}
